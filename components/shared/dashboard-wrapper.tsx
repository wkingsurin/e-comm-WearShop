...
export default function DashboardWrapper({
	...
	return (
		<div
			className={`flex flex-col gap-3 w-full min-h-[579px] p-6 rounded-lg border-[1px] border-[#E5E7EB] bg-white hover:shadow-[0_0_12px_-3px_rgba(0,0,0,.1)] transition-brand ${style}`}
		>
