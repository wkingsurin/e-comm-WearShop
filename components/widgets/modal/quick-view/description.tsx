            ...
            <div className="flex flex-col items-center gap-2 w-full">
                ...
                {currentVariant.stock !== 0 && (
                    <div className="flex items-center gap-4 w-full">
                        <div className="group/amount flex h-10 rounded-xl bg-white border-[0.5px] border-black/10 hover:border-black/15 hover:shadow-[0_0_9px_-3px_var(--black)]/25 transition-brand">
                            <Button
